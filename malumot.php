...
while($a=mysqli_fetch_assoc($result)){
    ...
    echo "<td style='padding: 10px 15px;font-size: 18px'>".$a['login']."</td>";
    echo "<td style='padding: 10px 15px;font-size: 18px'>".$a['password']."</td>";
    echo "<td style='padding: 10px 15px;font-size: 18px'>".$a['created_at']."</td>";
    echo "<td style='padding: 10px 15px;font-size: 18px'>".$a['updated_at']."</td>";
    echo "</tr>";
}
echo "</table>";
echo "</body>";
